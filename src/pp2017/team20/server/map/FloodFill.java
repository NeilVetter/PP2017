...
public class FloodFill {
	...
	Random rand = new Random();
		...
		//Erstelle eine ArrayListe um "freie" Felder zu f�llen.
	...
	// �berpr�ft ob die Position noch auf der Karte ist
	...
	// der eigentliche FloodFill Algorithmus
		private void floodfill(Point p, Random rand) {
			int[] array= new int[4];
			//For schleife um m�glich zuf�llige Richtungen zu erhalten
			...
			//While schleife um die zuf�lligen Richtungen zu �berpr�fen
			int i= 0;
			while(i<4){
