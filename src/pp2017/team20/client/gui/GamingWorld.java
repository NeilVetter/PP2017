...
public class GamingWorld extends JPanel {
	...
	public GamingWorld(GamingArea window) {
		...
		try {
			...
			monster1 = ImageIO.read(new File("img//waluigi1.png")); // http://vignette2.wikia.nocookie.net/fantendo/images/c/c3/Sochi_2014_olympic_wario_3d_render_by_ratchetmario-d8j2g4e.png/revision/latest?cb=20150517231540
			monster2 = ImageIO.read(new File("img//wario2.png")); // http://static.tvtropes.org/pmwiki/pub/images/waluigi-boardwin-mp9_1391.png
			monster3 = ImageIO.read(new File("img//bowser3.png")); // https://vignette1.wikia.nocookie.net/luigi/images/7/7c/Boo.png/revision/latest?cb=20080806155504&path-prefix=de
			monster6 = ImageIO.read(new File("img//hulk6.png")); // https://s-media-cache-ak0.pinimg.com/originals/c8/4f/92/c84f92638b3373ff3faf0ca6f4899b0c.png
		} catch (Exception e) {
...
//		6 = Monster
		...
		for (int i = 0; i < window.WIDTH; i++) {
			for (int j = 0; j < window.HEIGHT; j++) {
				...
				case 6:
					g.drawImage(floor, i * window.BOX, j * window.BOX, null);
					g.drawImage("monster.getget, i * window.BOX, j * window.BOX, null);
					break;
