...
public class RegistrationData extends JFrame {
	...
	// Ruft benoetigte swing Elemente auf.
	 ...
	 * Runnable() { public void run() { try { RegistrationData frame = new
	 * RegistrationData(); frame.setVisible(true); } catch (Exception e) {
	 * e.printStackTrace(); } } });}
	 */
	...
	public RegistrationData() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				/*
				 * ruft die Datenbank auf, testet ob die >Benutzername< und das
				 * >Passwort< schon vergeben ist. Wenn nicht speichere neuen
				 * >Benutzer< und >Passwort< in die Datenbank
				 */
				try {
					...
					if (i == 1) {
						...
						// Wenn Benuztername noch nicht vergeben, soll der neue
						// Spieler
